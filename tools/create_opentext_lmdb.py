...
def createDataset(outputPath, imagePathList, labelList, lexiconList=None, checkValid=True):
  ...
  ARGS:
      ...
      labelList     : list of corresponding groundtruth texts
                    : modified to the groundtruth imgs
...
if __name__ == "__main__":
  image_root_dir = '/home/mrchen/cmr/mosaic/KAIR/sr3/datasets'
  lmdb_output_path = '/home/mrchen/cmr/mosaic/DiG/data'
  image_folders = ['english_easy_train/hr_(128,512)', 'english_easy_train/hr_(128,512)']
